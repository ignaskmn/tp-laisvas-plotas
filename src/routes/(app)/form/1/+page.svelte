<script lang="ts">
	...
	async function handleSelection() {
		...
		if (!data) {
			...
			$form.services = $form.services.filter((storedService: { value: string }) =>
				$services.some((service: any) => service.value === storedService.value)
			);
		}
	}
...
<section class="layout">
	...
	<div class="input-container">
		<Select placeholder={'Pasirinkite objektą'} {items} bind:value={$form.object} name="object" />
	</div>
